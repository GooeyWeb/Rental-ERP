...
$.extend( $.validator, {
	...
	messages: {
		...
		url: "Proszę wprowadzić prawidłowe URL.",
		...
		equalTo: "Proszę znów wprowadzić taką samą wartość.",
		maxlength: $.validator.format( "Proszę wpisać nie więcej niż {0} znaków." ),
		minlength: $.validator.format( "Proszę wpisać nie mniej niż {0} znaków." ),
		rangelength: $.validator.format( "Proszę wpisać wartość o długości od {0} do {1} znaków." ),
		...
		step: $.validator.format( "Proszę wprowadzić wielokrotność liczby {0}." )
	},
